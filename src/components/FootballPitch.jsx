...
const LOGO_MAP = {
  ...
  'nottinghamforest.co.uk':   WP + 'Nottingham_Forest_FC_logo.svg',
  'rovers.co.uk':             WP + 'Blackburn_Rovers.svg',
  'burnleyfc.com':            WP + 'Burnley_FC_badge.svg',
  'heartsfc.co.uk':           WP + 'Heart_of_Midlothian_FC_logo.svg',
  'hibernianfc.co.uk':        WP + 'Hibernian_FC_logo.svg',
  'southamptonfc.com':        WP + 'Southampton_FC.svg',
  ...
  'lcfc.com':                 WP + 'Leicester_City_FC_logo.svg',
  'qpr.co.uk':              WP + 'Queens_Park_Rangers_crest_(2016).svg',
  ...
  'werder.de':                WP + 'SV_Werder_Bremen_logo.svg',
  'fc.de':                    WP + '1._FC_K%C3%B6ln_logo.svg',
  ...
  'rcdmallorca.es':           WP + 'RCD_Mallorca_logo.svg',
  ...
  'mallorca.es':              WP + 'RCD_Mallorca_logo.svg',
